...
public class TC_36_LANG extends BaseDriverParameter {
    ...
    public void testContentLanguage(String lang){
        ...
        Elements elements=new Elements(driver);
        elements.shopBtn.click();
        wait.until(ExpectedConditions.visibilityOf(elements.shopBtn));

        // Burayı yarın tamamlamış olurum
